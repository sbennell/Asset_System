...
export type LabelType = 'brother-dk22211' | 'brother-dk22211-bordered' | 'dymo-1933081' | 'dymo-labelmanager';
...
export function getLastLabelType(): LabelType | null {
  ...
  return value === 'brother-dk22211' || value === 'brother-dk22211-bordered' || value === 'dymo-1933081' || value === 'dymo-labelmanager'
    ? value
    : null;
}
